...
export { createObject, createScript, addEvent, removeEvent, listEvents, deleteResource, renameResource, registerResource, setSpriteProperties, createFolder, addRoomInstance, removeRoomInstance, listRoomInstances } from './resources.js';
